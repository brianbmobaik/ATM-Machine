...
set_property -dict { PACKAGE_PIN R10   IOSTANDARD LVCMOS33 } [get_ports { LED_out[6] }]; #IO_25_14 Sch=cb               CB
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { LED_out[6] }]; #IO_25_15 Sch=cc               CC
set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports { LED_out[6] }]; #IO_L17P_T2_A26_15 Sch=cd      CD
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { LED_out[6] }]; #IO_L13P_T2_MRCC_14 Sch=ce     CE
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { LED_out[6] }]; #IO_L19P_T3_A10_D26_14 Sch=cf  CF
set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { LED_out[6] }]; #IO_L4P_T0_D04_14 Sch=cg       CG
